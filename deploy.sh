...
kubectl run spainmobenv --image=docker.io/manar21/android-studio:junit-fabricplugin --command exec /bin/bash -c "trap : TERM INT; sleep infinity & wait" --replicas=2 --output=yaml --dry-run > spainmobenv-rc-test.yaml
